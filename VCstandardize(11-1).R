#Please read the readme.txt file included in this program for information on experimental and program set-up.

require(nplr)
library(nplr) #this package is for running N-parameter logistic regression analysis

directory <- "C:/Users/eso7/Documents/R/VCDATA/Outlier_Tests"#Direct a path to where the .csv files are stored. The last file is your folder (Broad_Tests)
...
custom_serumDfac <- c()#Input custom vibriocidal dilutions and change the variable on line 25
mAb <- c(2500, 1250, 625, 312.5, 156.25, 78.125, 39.0625, 19.53125, 9.765625, 4.8828125, 2.44140625)
custom_mAb <- c(1000,500,250,125,62.5,31.25,15.625,7.8125,3.90625,1.953125,0.9765625)#Input custom monoclonal antibody dilutions and change the variable on line 26
...
setwd("C:/Users/eso7/Documents/R/Results_Folder")#Direct a path to the folder where you would like the results file to be stored. The last file is your folder (Results_Folder).
